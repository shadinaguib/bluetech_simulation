...
def generate_launch_description():
    ...
    publish_from_joint_state = Node(
        package="bluetech_simulation",
        executable="publish_from_joint_state"
    )
    ...
    # run the keyboard_teleop node (control the robot with keyboard commands)

    # watch the robot localizae itself based on the joint state values
    return LaunchDescription([        
        ...
        rviz,
        publish_from_joint_state,
        move_robot,
        localization_from_gazebo
